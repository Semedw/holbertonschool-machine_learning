...
def projection_block(A_prev, filters, s=2):
    ...
    filters - a tuple or list containing F11, F3, F12, respectively:
        ...
        F12 - the number of filters in the second 1x1 convolution as well as the 1x1 convolution in the shortcut connection
    ...
    conv2 = K.layers.Conv2D(F3, kernel_size=3, strides=s,
    ...
    conv3 = K.layers.Conv2D(F12, kernel_size=1, strides=s,
