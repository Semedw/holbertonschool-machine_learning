...
class GaussianProcess:
    def __init__(self, X_init, y_init, l=1, sigma_f=1):
        ...
        Parameters:
        X_init (np.ndarray): Initial input data of shape (n_samples, n_features).
        y_init (np.ndarray): Initial output data of shape (n_samples,).
    ...
    def kernel(self, X1, X2):
        ...
        Parameters:
        X1 (np.ndarray): First input data of shape (n_samples, n_features).
        X2 (np.ndarray): Second input data of shape (n_samples, n_features).
